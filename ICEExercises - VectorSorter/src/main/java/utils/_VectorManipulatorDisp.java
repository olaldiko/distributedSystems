...
public abstract class _VectorManipulatorDisp extends Ice.ObjectImpl implements VectorManipulator
{
    ...
    private static Ice.DispatchStatus ___sort(VectorManipulator __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
    ...
    private static Ice.DispatchStatus ___copyWithoutDuplicates(VectorManipulator __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.startReadParams();
        int[] inVector;
