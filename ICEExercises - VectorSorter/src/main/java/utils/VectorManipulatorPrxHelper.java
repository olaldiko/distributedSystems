...
public final class VectorManipulatorPrxHelper extends Ice.ObjectPrxHelperBase implements VectorManipulatorPrx
{
    ...
    {
        return begin_copyWithoutDuplicates(inVector, null, false, __responseCb, __exceptionCb, null);
    }
    ...
    {
        return begin_copyWithoutDuplicates(inVector, null, false, __responseCb, __exceptionCb, __sentCb);
    }
    ...
    public Ice.AsyncResult begin_copyWithoutDuplicates(int[] inVector, 
                                                       ...
                                                       IceInternal.Functional_GenericCallback1<Ice.Exception> __exceptionCb)
    {
        return begin_copyWithoutDuplicates(inVector, __ctx, true, __responseCb, __exceptionCb, null);
    }
    ...
    public Ice.AsyncResult begin_copyWithoutDuplicates(int[] inVector, 
                                                       ...
                                                       IceInternal.Functional_BoolCallback __sentCb)
    {
        return begin_copyWithoutDuplicates(inVector, __ctx, true, __responseCb, __exceptionCb, __sentCb);
    }

    private Ice.AsyncResult begin_copyWithoutDuplicates(int[] inVector,
                                                        Map<String, String> __ctx,
                                                        boolean __explicitCtx,
                                                        Functional_GenericCallback1<int[]> __responseCb,
                                                        Functional_GenericCallback1<Exception> __exceptionCb,
                                                        Functional_BoolCallback __sentCb)
    {
        return begin_copyWithoutDuplicates(inVector, __ctx, __explicitCtx, false,
    ...
    public Ice.AsyncResult begin_sort(int[] inVector, 
                                      ...
                                      IceInternal.Functional_GenericCallback1<Ice.Exception> __exceptionCb)
    {
        return begin_sort(inVector, null, false, __responseCb, __exceptionCb, null);
    }
    ...
    public Ice.AsyncResult begin_sort(int[] inVector, 
                                      ...
                                      IceInternal.Functional_BoolCallback __sentCb)
    {
        return begin_sort(inVector, null, false, __responseCb, __exceptionCb, __sentCb);
    }
    ...
    public Ice.AsyncResult begin_sort(int[] inVector, 
                                      ...
                                      IceInternal.Functional_GenericCallback1<Ice.Exception> __exceptionCb)
    {
        return begin_sort(inVector, __ctx, true, __responseCb, __exceptionCb, null);
    }
    ...
    public Ice.AsyncResult begin_sort(int[] inVector, 
                                      ...
                                      IceInternal.Functional_BoolCallback __sentCb)
    {
        return begin_sort(inVector, __ctx, true, __responseCb, __exceptionCb, __sentCb);
    }
    ...
    private Ice.AsyncResult begin_sort(int[] inVector,
                                       ...
                                       Functional_BoolCallback __sentCb)
    {
        return begin_sort(inVector, __ctx, __explicitCtx, false,
                          new IceInternal.Functional_TwowayCallbackArg1<int[]>(__responseCb, __exceptionCb, __sentCb)
                              {
                                  public final void __completed(Ice.AsyncResult __result)
                                  {
