...
public final class CalculatorPrxHelper extends Ice.ObjectPrxHelperBase implements CalculatorPrx
{
    ...
    private static final String __lcd_name = "lcd";

    public int lcd(int num1, int num2)
    {
        return lcd(num1, num2, null, false);
    }

    public int lcd(int num1, int num2, java.util.Map<String, String> __ctx)
    {
        return lcd(num1, num2, __ctx, true);
    }

    private int lcd(int num1, int num2, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        __checkTwowayOnly(__lcd_name);
        return end_lcd(begin_lcd(num1, num2, __ctx, __explicitCtx, true, null));
    }

    public Ice.AsyncResult begin_lcd(int num1, int num2)
    {
        return begin_lcd(num1, num2, null, false, false, null);
    }

    public Ice.AsyncResult begin_lcd(int num1, int num2, java.util.Map<String, String> __ctx)
    {
        return begin_lcd(num1, num2, __ctx, true, false, null);
    }

    public Ice.AsyncResult begin_lcd(int num1, int num2, Ice.Callback __cb)
    {
        return begin_lcd(num1, num2, null, false, false, __cb);
    }

    public Ice.AsyncResult begin_lcd(int num1, int num2, java.util.Map<String, String> __ctx, Ice.Callback __cb)
    {
        return begin_lcd(num1, num2, __ctx, true, false, __cb);
    }
    ...
    public Ice.AsyncResult begin_lcd(int num1, 
                                     ...
                                     IceInternal.Functional_GenericCallback1<Ice.Exception> __exceptionCb)
    {
        return begin_lcd(num1, num2, null, false, false, __responseCb, __exceptionCb, null);
    }
    ...
    public Ice.AsyncResult begin_lcd(int num1, 
                                     ...
                                     IceInternal.Functional_BoolCallback __sentCb)
    {
        return begin_lcd(num1, num2, null, false, false, __responseCb, __exceptionCb, __sentCb);
    }
    ...
    public Ice.AsyncResult begin_lcd(int num1, 
                                     ...
                                     IceInternal.Functional_GenericCallback1<Ice.Exception> __exceptionCb)
    {
        return begin_lcd(num1, num2, __ctx, true, false, __responseCb, __exceptionCb, null);
    }
    ...
    public Ice.AsyncResult begin_lcd(int num1, 
                                     ...
                                     IceInternal.Functional_BoolCallback __sentCb)
    {
        return begin_lcd(num1, num2, __ctx, true, false, __responseCb, __exceptionCb, __sentCb);
    }

    private Ice.AsyncResult begin_lcd(int num1, 
                                      int num2, 
                                      java.util.Map<String, String> __ctx, 
                                      boolean __explicitCtx, 
                                      boolean __synchronous, 
                                      ...
                                      IceInternal.Functional_BoolCallback __sentCb)
    {
        return begin_lcd(num1, num2, __ctx, __explicitCtx, __synchronous, 
                         new IceInternal.Functional_TwowayCallbackInt(__responseCb, __exceptionCb, __sentCb)
                             {
                                 public final void __completed(Ice.AsyncResult __result)
                                 {
                                     CalculatorPrxHelper.__lcd_completed(this, __result);
                                 }
                             });
    }
    ...
    private Ice.AsyncResult begin_lcd(int num1, 
                                      ...
                                      IceInternal.CallbackBase __cb)
    {
        __checkAsyncTwowayOnly(__lcd_name);
        IceInternal.OutgoingAsync __result = getOutgoingAsync(__lcd_name, __cb);
        try
        {
            __result.prepare(__lcd_name, Ice.OperationMode.Normal, __ctx, __explicitCtx, __synchronous);
            IceInternal.BasicStream __os = __result.startWriteParams(Ice.FormatType.DefaultFormat);
            __os.writeInt(num1);
            __os.writeInt(num2);
            __result.endWriteParams();
    ...
    public int end_lcd(Ice.AsyncResult __iresult)
    {
        IceInternal.OutgoingAsync __result = IceInternal.OutgoingAsync.check(__iresult, this, __lcd_name);
        try
        {
            if(!__result.__wait())
            {
    ...
    static public void __lcd_completed(Ice.TwowayCallbackInt __cb, Ice.AsyncResult __result)
    {
        utils.CalculatorPrx __proxy = (utils.CalculatorPrx)__result.getProxy();
        int __ret = 0;
        try
        {
            __ret = __proxy.end_lcd(__result);
        }
        catch(Ice.LocalException __ex)
        {
            __cb.exception(__ex);
